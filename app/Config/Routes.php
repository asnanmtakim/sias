...
$routes->get('/surat-masuk', 'SuratUmum::indexSuratMasuk', ['filter' => 'role:superadmin,admin']);
$routes->get('/surat-masuk-all', 'SuratUmum::getAllSuratMasuk', ['filter' => 'role:superadmin,admin']);
$routes->get('/surat-masuk-add', 'SuratUmum::addSuratMasuk', ['filter' => 'role:superadmin,admin']);
$routes->get('/surat-masuk-edit/(:any)', 'SuratUmum::editSuratUmum/$1', ['filter' => 'role:superadmin,admin']);
$routes->get('/surat-keluar', 'SuratUmum::indexSuratKeluar', ['filter' => 'role:superadmin,admin']);
$routes->get('/surat-keluar-all', 'SuratUmum::getAllSuratKeluar', ['filter' => 'role:superadmin,admin']);
$routes->get('/surat-keluar-add', 'SuratUmum::addSuratKeluar', ['filter' => 'role:superadmin,admin']);
$routes->get('/surat-keluar-add/(:any)', 'SuratUmum::addSuratKeluar/$1', ['filter' => 'role:superadmin,admin']);
$routes->get('/surat-keluar-edit/(:any)', 'SuratUmum::editSuratUmum/$1', ['filter' => 'role:superadmin,admin']);
$routes->post('/surat-umum-add', 'SuratUmum::saveSuratUmum', ['filter' => 'role:superadmin,admin']);
$routes->post('/surat-umum-edit', 'SuratUmum::updateSuratUmum', ['filter' => 'role:superadmin,admin']);
$routes->get('/surat-umum-detail/(:any)', 'SuratUmum::detailSuratUmum/$1', ['filter' => 'role:superadmin,admin']);
$routes->get('/surat-umum-delete/(:any)', 'SuratUmum::deleteSuratUmum/$1', ['filter' => 'role:superadmin,admin']);
