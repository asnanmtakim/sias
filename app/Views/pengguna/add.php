    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Tambah Data Pengguna <?= $app_identity['app_title']; ?></h2>
                        ...
                        <form action="<?= base_url() ?>/pengguna-add" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-12 form-group mb-3">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('fullname')) ? 'is-invalid' : ''; ?>" id="fullname" name="fullname" value="<?= old('fullname'); ?>" placeholder="Nama Pengguna">
                                ...
                                <div class="col-sm-12 form-group mb-3">
                                    ...
                                    <input type="email" class="form-control <?= ($validation->hasError('email')) ? 'is-invalid' : ''; ?>" id="email" name="email" value="<?= old('email'); ?>" placeholder="Email Pengguna">
                                    <div class="invalid-feedback">
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group mb-3">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('username')) ? 'is-invalid' : ''; ?>" id="username" name="username" value="<?= old('username'); ?>" placeholder="Username">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-sm-6 form-group mb-3">
                                    ...
                                    <select class="form-control select2 <?= ($validation->hasError('group')) ? 'is-invalid' : ''; ?>" id="group" name="group" style="width: 100%;">
                                        ...
                                        <?php foreach ($group as $rl) : ?>
                                            <option value="<?= $rl['name'] ?>" <?php if (old('group') == $rl['name']) {
                                                                                    print 'selected';
                                                                                } else {
                                                                                    print '';
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 form-group mb-3">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('phone')) ? 'is-invalid' : ''; ?>" id="phone" name="phone" value="<?= old('phone'); ?>" placeholder="No HP Pengguna">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-sm-12 form-group mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3 mb-2">
                                            <img src="<?= base_url(); ?>/uploads/image_user/default.png" class="img-thumbnail img-preview">
                                        </div>
                                        <div class="col-sm-9">
