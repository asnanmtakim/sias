   ...
   <div class="">
      ...
      <div class="row">
         <div class="col-md-12 col-sm-12">
            <div class="x_panel">
               <div class="x_title">
                  <h2>Data Surat Masuk <?= $app_identity['app_title']; ?></h2>
                  <div class="nav navbar-right panel_toolbox">
                     <a href="<?= base_url(); ?>/surat-masuk-add" class="btn btn-sm btn-success"><i class="fa fa-plus-circle"></i> Tambah</a>
                  </div>
                  <div class="clearfix"></div>
               </div>
               <div class="x_content">
