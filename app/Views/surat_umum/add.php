                            ...
                            <div class="row">
                                <div class="col-sm-3 form-group mb-3">
                                    ...
                                    <select class="form-control select2 <?= ($validation->hasError('type')) ? 'is-invalid' : ''; ?>" id="type" name="type">
                                        ...
                                        <option value="1" <?= (old('type') == '1') ? 'selected' : '' ?>>Biasa</option>
                                        <option value="2" <?= (old('type') == '2') ? 'selected' : '' ?>>Rahasia</option>
                                        <?php if (in_groups('superadmin')) : ?>
                                            <option value="3" <?= (old('type') == '3') ? 'selected' : '' ?>>Sangat Rahasia</option>
                                        <?php endif; ?>
                                    </select>
                                    <div class="invalid-feedback">
