        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="<?= base_url() ?>/surat-umum-edit" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="id_surat_umum" value="<?= $surat['id_surat_umum']; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col form-group mb-3">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('pengirim')) ? 'is-invalid' : ''; ?>" id="pengirim" name="pengirim" value="<?= old('pengirim') ? old('pengirim') : $surat['pengirim']; ?>" placeholder="Pengirim Surat">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col form-group mb-3">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('penerima')) ? 'is-invalid' : ''; ?>" id="penerima" name="penerima" value="<?= old('penerima') ? old('penerima') : $surat['penerima']; ?>" placeholder="Penerima Surat">
                                    <div class="invalid-feedback">
                            ...
                            <div class="row">
                                <div class="col-sm-12 form-group mb-3">
                                    ...
                                    <textarea class="form-control <?= ($validation->hasError('isi_surat')) ? 'is-invalid' : ''; ?>" id="isi_surat" name="isi_surat" placeholder="Isi Surat"><?= old('isi_surat') ? old('isi_surat') : $surat['isi_surat']; ?></textarea>
                                    <div class="invalid-feedback">
                                            ...
                                            <?php foreach ($surat_masuk as $sm) : ?>
                                                <option value="<?= $sm['id_surat_umum'] ?>" <?php
                                                                                            if (old('surat_masuk')) {
                                                                                                ...
                                                                                                if ($surat['id_surat_masuk'] == $sm['id_surat_umum']) {
                                                                                                    print 'selected';
                                                                                                } else {
                                                                                                    print '';
                                                                                                }
