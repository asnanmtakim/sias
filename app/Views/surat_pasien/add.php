        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="<?= base_url() ?>/surat-pasien-add" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="row">
                                ...
                                <div class="col form-group mb-3">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('nama_pasien')) ? 'is-invalid' : ''; ?>" id="nama_pasien" name="nama_pasien" value="<?= old('nama_pasien'); ?>" placeholder="Nama Pasien">
                                    <div class="invalid-feedback">
                            ...
                            <div class="row">
                                <div class="col-sm-3 form-group mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control <?= ($validation->hasError('tgl_masuk')) ? 'is-invalid' : ''; ?>" id="tgl_masuk" name="tgl_masuk" value="<?= old('tgl_masuk'); ?>" placeholder="Tgl Masuk Pasien">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-sm-3 form-group mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control <?= ($validation->hasError('tgl_keluar')) ? 'is-invalid' : ''; ?>" id="tgl_keluar" name="tgl_keluar" value="<?= old('tgl_keluar'); ?>" placeholder="Tgl Keluar Pasien">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col form-group mb-3">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('diagnosa')) ? 'is-invalid' : ''; ?>" id="diagnosa" name="diagnosa" value="<?= old('diagnosa'); ?>" placeholder="Diagnosa">
                                    <div class="invalid-feedback">
                            ...
                            <div class="row">
                                <div class="col-sm-3 form-group mb-3">
                                    ...
                                    <div class="radio">
                                        <input type="radio" value="1" name="jenis_surat" <?= old('jenis_surat') == '1' ? 'checked' : ''; ?> id="jenis_surat_1"> <label for="jenis_surat_1">Umum</label>
                                        <input type="radio" value="2" name="jenis_surat" <?= old('jenis_surat') == '2' ? 'checked' : ''; ?> id="jenis_surat_2"> <label for="jenis_surat_2">BPJS</label>
                                    </div>
                                ...
                                <div class="col form-group mb-3" id="bpjs" style="display: none;">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('no_bpjs')) ? 'is-invalid' : ''; ?>" id="no_bpjs" name="no_bpjs" value="<?= old('no_bpjs'); ?>" placeholder="No BPJS">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col form-group mb-3">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('tagihan')) ? 'is-invalid' : ''; ?>" id="tagihan" name="tagihan" value="<?= old('tagihan'); ?>" placeholder="Tagihan">
                                    <div class="invalid-feedback">
